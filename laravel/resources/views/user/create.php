		...
		<form class="form-horizontal" method="post" action="createad" id="notEmptyForm">
			<div class="form-group">
			    <div class="input-group col-sm-4">
			      ...
			      <input type="text" class="form-control" name="txtid" placeholder="Identification" required autocomplete="off">
			    </div>
			</div>
			<div class="form-group">
			    <div class="input-group col-sm-4">
			...
			<div class="form-group">
			    <div class="input-group col-sm-4">
			      ...
			      <textarea class="form-control" rows="5" name="txtinfo" placeholder="Hi, if you wish to say something you can write on me!" required autocomplete="off">
